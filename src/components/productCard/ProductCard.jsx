...
function ProductCard() {
    ...
    const { mode, products } = context; // Use products after filtering
                                        ...
                                        <div className="p-5 border-t-2">
                                            ...
                                            <div className="flex justify-center">
                                                <button
                                                    ...
                                                    className="focus:outline-none text-white bg-yellow-600 hover:bg-yellow-700 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm w-full py-2"
                                                >
                                                    Add To Cart
                                                </button>
                                            </div>
