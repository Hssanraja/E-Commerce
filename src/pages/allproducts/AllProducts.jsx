                      ...
                      <div className="p-5 border-t-2">
                        ...
                        <div className=" flex justify-center">
                          <button type="button"
                            ...
                            className="focus:outline-none text-white bg-yellow-600 hover:bg-yeloow-700 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm w-full  py-2">Add To Cart</button>
                        </div>
                      </div>
                    </div>
                  </div>
